...
//表示件数用の変数
            ...
            for ($i=1;$i<=$h;$i++) {
                ...
                if (!$_SESSION["search_result_tweet"][$i-1]["tweet_id"]) {
                    //tweet主のリンク先の作成
                    //画像のリンク                        
...
//        echo '<span style="margin-right: 6px;"></span>';
                    ...
                    //投稿日の登録
                    echo '<span id="time">' . substr($_SESSION["search_result_tweet"]["created_at"], 0, 10) . "</span><br>";
                    echo '<FONT size=4>' . $_SESSION["search_result_tweet"]["tweet"] . "</FONT></br>";
